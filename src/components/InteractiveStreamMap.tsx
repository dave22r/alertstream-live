  ...
  return (
    <div className="relative rounded-xl border border-zinc-800 bg-zinc-900 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 2 }}>
            ...
            <div className="bg-zinc-900 border border-zinc-700 rounded-lg shadow-2xl p-4">
              <div className="flex items-start justify-between gap-3 mb-3">
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-6 w-6 text-zinc-500 hover:text-white -mr-1 -mt-1"
        ...
        {/* Legend */}
        <div className="absolute bottom-4 right-4 bg-zinc-900 border border-zinc-700 rounded-lg px-3 py-2 pointer-events-auto">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              <div className="h-4 w-4 rounded-full bg-red-600 border-2 border-white shadow" />
              <span className="text-xs text-zinc-300">Live Stream</span>
            </div>
        ...
        {/* Instructions */}
        <div className="absolute top-4 left-4 bg-zinc-900 border border-zinc-700 rounded-lg px-3 py-2 pointer-events-auto">
          <div className="flex items-center gap-2 text-xs text-zinc-400">
        ...
        {streams.length > validStreams.length && (
          <div className="absolute top-4 right-4 bg-amber-900 border border-amber-700/50 rounded-lg px-3 py-2 pointer-events-auto">
